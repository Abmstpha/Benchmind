              ...
              {expandedRun === run.run_id && (
                <div className="border-t bg-blue-50 p-4">
                  <div className="text-sm text-blue-800">
                    ...
                    - Expanded Run ID: {expandedRun}<br/>
                    - Current Run ID: {run.run_id}<br/>
                    - Has Recommendation: {run.recommendation ? 'YES' : 'NO'}<br/>
                    - Recommendation Type: {typeof run.recommendation}<br/>
                    {run.recommendation && (
                      <>
                        - Winner: {run.recommendation.winner?.model || 'Not found'}<br/>
                        - Reason: {run.recommendation.winner?.reason || 'Not found'}<br/>
                      </>
                    )}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-lg p-4 border-2 border-green-200">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <h4 className="font-semibold text-gray-900">Recommended Model</h4>
                      </div>
                      <div className="space-y-2">
                        <div className="font-medium text-lg">{run.recommendation.winner.model}</div>
                        <div className="text-sm text-gray-600">{run.recommendation.winner.reason}</div>
